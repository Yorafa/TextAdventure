...
public class ExplorePanel extends BasePanel {
    ...
    public ExplorePanel(TextAdventureFrame parent, Driver driver) {
        super(parent, driver);
        pokemonManager = driver.getPokemonManager();
        mapManager = driver.getMapManager();
        saveLoadController = driver.getSaveLoadController();
        initialize();
    }
    ...
    private void initialize() {
        ...
        mainPanel.add(new SaveLoadPanel(driver));
    ...
    private void doSearch() {
        driver.setWildPokemon(mapManager.walkAround(pokemonManager));
        if (driver.getWildPokemon() == null) {
